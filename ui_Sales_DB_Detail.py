...
# Form implementation generated from reading ui file 'D:\TosoProgram\TosoFrame\TosoFrame\res_Sales\Sales_DB_Detail.ui'
#
...
class Ui_Sales_DB_Detail(object):
    def setupUi(self, Sales_DB_Detail):
        Sales_DB_Detail.setObjectName(_fromUtf8("Sales_DB_Detail"))
        Sales_DB_Detail.resize(1408, 836)
        self.layoutWidget = QtGui.QWidget(Sales_DB_Detail)
        ...
        self.label_dbcode = QtGui.QLabel(self.layoutWidget)
        self.label_dbcode.setMinimumSize(QtCore.QSize(320, 0))
        self.label_dbcode.setMaximumSize(QtCore.QSize(320, 16777215))
        ...
        self.label_dbcode.setPalette(palette)
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("宋体"))
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.label_dbcode.setFont(font)
        self.label_dbcode.setObjectName(_fromUtf8("label_dbcode"))
        self.gridLayout.addWidget(self.label_dbcode, 0, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_socode, 1, 1, 1, 1)
        ...
        self.tableView = QtGui.QTableView(Sales_DB_Detail)
        ...
        self.retranslateUi(Sales_DB_Detail)
        QtCore.QMetaObject.connectSlotsByName(Sales_DB_Detail)

    def retranslateUi(self, Sales_DB_Detail):
        Sales_DB_Detail.setWindowTitle(_translate("Sales_DB_Detail", "Form", None))
        self.label.setText(_translate("Sales_DB_Detail", "发货单号", None))
        self.label_dbcode.setText(_translate("Sales_DB_Detail", "dbcode", None))
        self.label_2.setText(_translate("Sales_DB_Detail", "客户简称", None))
        self.label_soabbname.setText(_translate("Sales_DB_Detail", "abbname", None))
        self.label_4.setText(_translate("Sales_DB_Detail", "发货单日期", None))
        self.label_date.setText(_translate("Sales_DB_Detail", "date", None))
        self.label_3.setText(_translate("Sales_DB_Detail", "订单号", None))
        self.label_socode.setText(_translate("Sales_DB_Detail", "socode", None))
        self.label_11.setText(_translate("Sales_DB_Detail", "业务员", None))
        self.label_person.setText(_translate("Sales_DB_Detail", "person", None))
        self.label_8.setText(_translate("Sales_DB_Detail", "备注", None))
        self.label_memo.setText(_translate("Sales_DB_Detail", "memo", None))
        self.label_10.setText(_translate("Sales_DB_Detail", "扣率%", None))
        self.label_koulv.setText(_translate("Sales_DB_Detail", "koulv", None))
        self.label_6.setText(_translate("Sales_DB_Detail", "发运方式", None))
        self.label_scname.setText(_translate("Sales_DB_Detail", "scname", None))
        self.label_9.setText(_translate("Sales_DB_Detail", "制单人", None))
        self.label_maker.setText(_translate("Sales_DB_Detail", "maker", None))
        self.label_7.setText(_translate("Sales_DB_Detail", "审核人", None))
        self.label_verifier.setText(_translate("Sales_DB_Detail", "verifier", None))
        self.label_14.setText(_translate("Sales_DB_Detail", "销售收入", None))
        self.label_income.setText(_translate("Sales_DB_Detail", "income", None))
